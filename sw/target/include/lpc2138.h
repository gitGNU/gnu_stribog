...
#define PINSEL0_CAP02	(2<<12)
#define PINSEL0_AD10	(3<<12)
#define PINSEL0_SSEL0	(1<<14)
#define PINSEL0_PWM2	(2<<14)
#define PINSEL0_EINT2	(3<<14)
#define PINSEL08MASK		(~(3<<16))
#define PINSEL0_TXD1MASK	PINSEL08MASK
#define PINSEL0_PWM4MASK	PINSEL08MASK
#define PINSEL0_AD11MASK	PINSEL08MASK
#define PINSEL0_TXD1	(1<<16)
#define PINSEL0_PWM4	(2<<16)
#define PINSEL0_AD11	(3<<16)
#define PINSEL09MASK	(~(3<<18))
#define PINSEL0_RXD1MASK	PINSEL09MASK
#define PINSEL0_PWM6MASK	PINSEL09MASK
#define PINSEL0_EINT3MASK	PINSEL09MASK
#define PINSEL0_RXD1	(1<<18)
#define PINSEL0_PWM6	(2<<18)
#define PINSEL0_EINT3	(3<<18)
#define PINSEL10MASK	(~(3<<20))
#define PINSEL0_RTS1MASK	PINSEL10MASK
#define PINSEL0_CAP10MASK	PINSEL10MASK
#define PINSEL0_AD12MASK	PINSEL10MASK
...
#define PINSEL1_020MASK		(~(3<<8))
#define PINSEL1_MAT13_P020MASK	PINSEL020MASK
#define PINSEL1_SSELMASK	PINSEL020MASK
#define PINSEL1_EINT3_P20MASK	PINSEL020MASK
#define PINSEL1_MAT13_P020	(1<<8)
#define PINSEL1_SSEL		(2<<8)
#define PINSEL1_EINT3_P20	(3<<8)
#define PINSEL1_021MASK		(~(3<<10))
#define PINSEL1_PWM5MASK	PINSEL021MASK
#define PINSEL1_AD16MASK	PINSEL021MASK
#define PINSEL1_CAP13_P21MASK	PINSEL021MASK
#define PINSEL1_PWM5		(1<<10)
#define PINSEL1_AD16		(2<<10)
#define PINSEL1_CAP13_P21	(3<<10)
#define PINSEL1_022MASK		(~(3<<12))
#define PINSEL1_AD17MASK	PINSEL022MASK
#define PINSEL1_CAP00_P022MASK	PINSEL022MASK
#define PINSEL1_MAT00_P022MASK	PINSEL022MASK
#define PINSEL1_AD17		(1<<12)
#define PINSEL1_CAP00_P022	(2<<12)
#define PINSEL1_MAT00_P022	(3<<12)
#define PINSEL1_025MASK		(~(3<<18))
#define PINSEL1_AD04MASK	PINSEL025MASK
#define PINSEL1_DACMASK		PINSEL025MASK
#define PINSEL1_AD04		(1<<18)
#define PINSEL1_DAC		(2<<18)
#define PINSEL1_026MASK		(~(3<<20))
#define PINSEL1_AD05MASK	PINSEL026MASK
#define PINSEL1_AD05		(1<<20)
#define PINSEL1_027MASK		(~(3<<22))
#define PINSEL1_AD00MASK	PINSEL027MASK
#define PINSEL1_CAP01_P027MASK	PINSEL027MASK
#define PINSEL1_MAT01_P027MASK	PINSEL027MASK
#define PINSEL1_AD00		(1<<22)
#define PINSEL1_CAP01_P027	(2<<22)
#define PINSEL1_MAT01_P027	(3<<22)
#define PINSEL1_028MASK		(~(3<<24))
#define PINSEL1_AD01MASK	PINSEL028MASK
#define PINSEL1_CAP02_P028MASK	PINSEL028MASK
#define PINSEL1_MAT02_P028MASK	PINSEL028MASK
#define PINSEL1_AD01		(1<<24)
#define PINSEL1_CAP02_P028	(2<<24)
#define PINSEL1_MAT02_P028	(3<<24)
#define PINSEL1_029MASK		(~(3<<26))
#define PINSEL1_AD02MASK	PINSEL029MASK
#define PINSEL1_CAP03_P029MASK	PINSEL029MASK
#define PINSEL1_MAT03_P029MASK	PINSEL029MASK
#define PINSEL1_AD02		(1<<26)
#define PINSEL1_CAP03_P029	(2<<26)
#define PINSEL1_MAT03_P029	(3<<26)
#define PINSEL1_030MASK		(~(3<<28))
#define PINSEL1_AD03MASK	PINSEL030MASK
#define PINSEL1_EINT3_P030MASK	PINSEL030MASK
#define PINSEL1_CAP00_P030MASK	PINSEL030MASK
