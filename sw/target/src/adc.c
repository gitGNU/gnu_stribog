...
const unsigned*
get_adc(void){if(lock(&data_read))return 0;return channels;}
static void qu0(void)__attribute__((interrupt("IRQ")));
static void
qu0(void)
{unsigned c,cn;static int j;
 while((c=AD0DR)&AD_DONE)
 {ch0[cn=(c>>24)&7]=(c>>6)&0x3FF;
  if(cn==7){if(j!=4)j++;else{j=0;unlock(&data_read);}}
 }VICVectAddr=0;
}
...
{init_dac();
 ...
 VICIntEnable=(1<<VIC_AD0)|(HAVE_ADC1?(1<<VIC_AD1):0);
 PINSEL0&=PINSEL0_AD12MASK&PINSEL0_AD07MASK;
 PINSEL0|=PINSEL0_AD07|(HAVE_ADC1?PINSEL0_AD12:0);
 PINSEL1&=PINSEL1_AD00MASK&PINSEL1_AD01MASK&PINSEL1_AD02MASK&
  PINSEL1_AD03MASK&PINSEL1_AD04MASK&PINSEL1_AD05MASK&
  PINSEL1_AD16MASK&PINSEL1_AD17MASK;
 PINSEL1|=PINSEL1_AD00|PINSEL1_AD01|PINSEL1_AD02|
  PINSEL1_AD03|PINSEL1_AD04|PINSEL1_AD05|
   (HAVE_ADC1?(PINSEL1_AD16|PINSEL1_AD17):0);
 AD0CR=(0xBF)|(11<<8)|AD_PDN|AD_BURST;
 if(HAVE_ADC1)AD1CR=(0xC4)|(33<<8)|AD_PDN|AD_BURST;
 lock(&data_read);
}
