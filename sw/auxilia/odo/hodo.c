...
#define PORT_MASK	(1<<5)
static unsigned char capta[256],caput,cauda,missa[5],i=sizeof(missa);
static unsigned cnt;
static void init(void)
{UBRRH=0;UBRRL=F_CPU/BAUD/16-1;UCSRB=(1<<RXEN)|(1<<TXEN);UCSRC=FRAME;
...
{static unsigned char c1,c2;unsigned char c=PINC&PORT_MASK;
